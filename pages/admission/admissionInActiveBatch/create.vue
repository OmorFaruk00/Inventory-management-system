                                ...
                                <div class="tab-pane" :class="generalStep ? 'active' : ''">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mt-10">
                                            ...
                                            <select class="form-control" v-model="student.batch_id" required v-else @change="fetchShiftGroup">
...
<!-- 
                                ...
                                <div class="tab-pane" :class="othersStep ? 'active' : ''">
                                        ...
                                        <div class="card mb-2">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="refereed_by_parent_id">Referred By</label>
                                                            <select name="refereed_by_parent_id"
                                                                @change="changeReferredBy()" id="refereed_by_parent_id"
                                                                v-model="student.refereed_by_parent_id"
                                                                class="form-control">
                                                                <option v-for="(
                                    refereedByParent, index
                                                            ...
                                                            <small v-if="errors.refereed_by_parent_id"
                                                                class="text-danger with-errors"
                                                                v-html="errors.refereed_by_parent_id[0]"></small>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-4 col-md-6 col-sm-12"
                                                        v-show="student.refereed_by_parent_id == 1">
                                                        <div class="form-group">
                                    ...
                                    refeByStdType, index
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12" v-show="
                                                        student.refereed_by_parent_id != '' &&
                                                        student.refereed_by_parent_id != 1
                                                    ">
                                                        <div class="form-group">
                                                            <label for="ref_val">
                                                                <span v-if="student.refereed_by_parent_id == 2">Liaison
                                                                    Officer's Code</span>
                                                                <span
                                                                    v-else-if="student.refereed_by_parent_id == 3">Student's
                                                                    Reg.Code</span>
                                                                <span v-else>Employee's Email</span>
                                                            </label>
                                                            <input type="text" class="form-control" id="ref_val"
                                                                name="ref_val" v-model="student.ref_val" />

                                                            <small v-if="errors.ref_val" class="text-danger with-errors"
                                                                v-html="errors.ref_val[0]"></small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
export default {
    ...
    data() {
        return {
            ...
            config: {
                ...
                token: "{{ session('token') }}",
                redirect_path: "{{ route('admissionInActiveBatch.index') }}"
            },
    ...
    methods: {
        ...
        generalInfo() {
            ...
            if (!this.student.admission_season) {
                this.$toaster.error("Please select admission season");
                return false;
            }

            /*if (!this.student.admission_semester_code) {
                this.$toaster.error("Please select admission semester code");
                return false;
            }*/

            /*if (!this.student.hall_code) {
                this.$toaster.error("Please enter hall code");
                return false;
            }*/
