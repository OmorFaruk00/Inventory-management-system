        ...
        <div class="form-horizontal">
          ...
          <div v-if="show">
            <div class="form-group focused">
              ...
              <h6
                class="text-danger"
                v-if="error.student_name"
                v-text="error.student_name[0]"
              ></h6>
            ...
            <div class="d-flex justify-content-end">
              <button
                type="submit"
                class="btn btn-submit mr-4"
                @click="form_sales"
              >
                Submit
              </button>
              <button type="reset" class="btn btn-reset btn-sm mr-3">
                Reset
              </button>
