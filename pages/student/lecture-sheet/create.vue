    ...
    <div class="form-bg py-5">
        <div class="col-md-8 offset-md-2">
            <div class="form-shadow p-5">
                <h3 class="title">Create lecture sheet</h3>
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xl-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Select Department First"
                                    v-if="!batches" />
                                <select class="form-control" v-model="lecture.batch" required v-else @change="fetchCourse()">
                    ...
                    <div class="d-flex justify-content-end pt-3">
                        <button class="btn-submit" @click.prevent="addlecture()">Submit</button>
                    </div>
                </form>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        addlecture() {
            ...
            this.$axios
                .$post("/lecture-sheet/add", formData)
                .then((res) => {                   
                    this.errors = {};
                    this.$toaster.success("Lecture Sheet Added Successfully");
