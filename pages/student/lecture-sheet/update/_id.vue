                        ...
                        <div class="col-md-12 col-xl-6 col-sm-12">
                            <div class="form-group">
                                <label>Batch *</label>
                                            ...
                                            <select class="form-control" v-model="lecture.batch" required 
                                                >
                        ...
                        <div class="col-md-12 col-xl-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" placeholder=""
                                    @change="(e) => (lecture.new_file = e.target.files[0])" accept="image/*" />
    ...
    methods: {
        ...
        updatelecture() {
            ...
            this.$axios
                ...
                .then((res) => {                    
                    this.errors = {};
                    this.$toaster.success("lecture Sheet Update Successfully");
