            ...
            <div class="panel-heading">
              <div class="row">
                ...
                <div class="col-sm-7 col-xs-12 text-right mb-2">
                  <nuxt-link to="/student/course/create" class="btn-add"><svg height='25px'
              ...
              <table class="table table-striped text-center">
                ...
                <tbody>
                  <tr v-for="(course,index) in courses" :key="index">
                    ...
                    <td>
                      <nuxt-link :to="`/student/course/update/${course.id}`" class="btn-edit py-2 mr-3 btn-responsive"><svg height='20px' xmlns="http://www.w3.org/2000/svg"
                      ...
                      <button class="btn-delete" @click="courseDelete(course.id)"><svg height='18px'
