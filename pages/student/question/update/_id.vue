    ...
    <div class="form-bg py-5">
        <div class="col-md-8 offset-md-2">
            <div class="form-shadow p-5">
                <h3 class="title">Update question</h3>
                   ...
                   <div class="row">                       
                        ...
                        <div class="col-md-12 col-xl-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="question.department" @change="fetchBatch(),fetchCourse()">
                        ...
                        <div class="col-md-12 col-xl-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" disabled class="form-control"
                                            ...
                                            <select class="form-control" v-model="question.batch" required v-else
                                                >
                     ...
                     <div class="d-flex justify-content-end pt-3">
                        <button class="btn-submit" @click.prevent="updateQuestion()">Submit</button>
                    </div>
                </form>
...
export default {
    ...
    methods: {
          fetchQuestionInfo() {
            this.$axios.$get('question/edit/'+this.$route.params.id).then(response => {
        ...
        updateQuestion() {
            ...
            formData.append('description', this.question.description)
              if(this.question.new_file){
                formData.append('new_file', this.question.new_file)
            }            
            // formData.append('file', this.question.file)

            this.$axios
                .$post("/question/update/"+this.$route.params.id, formData)
                .then((res) => {                    
                    this.errors = {};
                    this.$toaster.success("Question Update Successfully");
