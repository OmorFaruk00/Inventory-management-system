            ...
            <div class="form-container">
                ...
                <form class="form-horizontal">
                        ...
                        <div class="col-md-6 col-xl-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" placeholder=""
                                    @change="(e) => (committee.new_image = e.target.files[0])" accept="image/*" />
                    ...
                    <div class="d-flex justify-content-end pt-3">
                        <button class="btn-submit" @click.prevent="UpdateCommittee()">Update</button>
                    </div>
                </form>
...
export default {
    ...
    methods: {
        getCommittee() {
            this.$axios
                .$get("/committee/edit/" + this.$route.params.id)
                .then((res) => {
        ...
        UpdateCommittee() {
            ...
            this.$axios
                .$post("/committee/update/" + this.$route.params.id, formData)
                .then((res) => {
                    this.committee = "";
                    this.errors = {};
                    this.$toaster.success("committee Added Successfully");
                    this.$router.push("/web-dui/committee");
                })
                .catch((error) => {
