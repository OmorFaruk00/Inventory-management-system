...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    editBatch() {
      this.$axios.$get("/admission/batch-edit/" + this.$route.params.id).then(response => {
    ...
    updateBatch() {
      this.$axios.$post("/admission/batch-update/" + this.$route.params.id, this.batch).then(response => {
...
// CONCATENATED MODULE: ./pages/admission/batch/update/_id.vue?vue&type=script&lang=js&
 /* harmony default export */ var update_idvue_type_script_lang_js_ = (_idvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admission/batch/update/_id.vue
